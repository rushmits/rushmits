...
<head>
	...
	<title>CliqHR | Fastway Transmissions Pvt. Ltd</title>
	...
	<script>
		...
		function set_interval() {
			//timer = setInterval("auto_logout()", 1000*120);
		}
		function reset_interval() {
			if (timer != 0) {
				clearInterval(timer);
				timer = 0;
				timer = setInterval("auto_logout()", 1000*300);
				console.log("Interval Reset");
			}
		}
		function auto_logout() {
			/*alertify.alert('System Alert', 'Your session has expired, Please Login Again.', function(){ 
				alertify.error('Logout...'); 
...
<?php  master_sidebar(); ?>
<input type="hidden" value="<?php echo base_url(); ?>" class="base_url" id="base_url"/>
<div id="right-panel" class="right-panel">
<header id="header" class="header">
	<div class="header-menu">
		<div class="col-sm-7">
			<a href="javascript:void(0)" id="menuToggle" class="menutoggle pull-left"><i class="fa fa fa-tasks"></i></a>
			<div class="header-left">
				...
				<div class="dropdown for-notification">
					...
					<div class="dropdown-menu" aria-labelledby="notification">
						...
						<a class="dropdown-item media bg-flat-color-1" href="<?php echo base_url() ;?>#">
							<i class="fa fa-check"></i>
							<p>Server #1 overloaded.</p>
						</a>
						<a class="dropdown-item media bg-flat-color-4" href="<?php echo base_url() ;?>#">
							<i class="fa fa-info"></i>
							<p>Server #2 overloaded.</p>
						</a>
						<a class="dropdown-item media bg-flat-color-5" href="<?php echo base_url() ;?>#">
				...
				<div class="dropdown for-message">
					...
					<div class="dropdown-menu" aria-labelledby="message">
						...
						<a class="dropdown-item media bg-flat-color-3" href="<?php echo base_url() ;?>#">
		...
		<div class="col-sm-5">
			<div class="user-area dropdown float-right">
				<a href="<?php echo base_url() ;?>#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
